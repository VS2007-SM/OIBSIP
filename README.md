...
## 🛠️ Tech Stack
- **Language:** Python 3
- **Libraries:** (updated as tasks progress) — standard library, `requests` (Weather App), `speech_recognition` (Voice Assistant), `socket`/`tkinter` (Chat Application)

## 🚀 How to Use
```bash
git clone https://github.com/<your-username>/OIBSIP.git
cd OIBSIP/Task1_BMICalculator
...
---
*Certificate of Completion pending — minimum 3 tasks required, 5 targeted.*
