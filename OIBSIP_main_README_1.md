...
<td>Beginner</td>
<td>✅ Done</td>
<td>Input validation, unit conversion, function design</td>
</tr>
...
<td>Beginner</td>
<td>🔄 In Progress</td>
<td>Randomization, character sets, security rules</td>
</tr>
...
- **Language:** Python 3 (standard library first, minimal external deps)
- **Libraries used across tasks:** `random`, `string`, `requests` (Weather App)
...
# Navigate to any task and run it
